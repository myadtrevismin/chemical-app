...
import com.org.order.QAccounts;
...
public interface AccountsRepo
		extends JpaRepository<Accounts, Long>, QuerydslPredicateExecutor<Accounts>, QuerydslBinderCustomizer<QAccounts> {
	@Override
	default void customize(QuerydslBindings bindings, QAccounts obj) {
		...
		bindings.bind(obj.invoiceNo).first((StringPath path, String value) -> {
