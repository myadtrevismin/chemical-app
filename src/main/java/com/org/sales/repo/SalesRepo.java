...
public interface SalesRepo
		extends JpaRepository<Sales, Long>, QuerydslPredicateExecutor<Sales>, QuerydslBinderCustomizer<QSales> {
	@Override
	default void customize(QuerydslBindings bindings, QSales obj) {
