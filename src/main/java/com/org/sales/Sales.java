...
public class Sales extends Audit {
	...
	private Set<SalesProduct> products;

	@OneToMany(mappedBy = "reference")
	private Set<SalesUser> users;
	...
	public Set<SalesProduct> getProducts() {
		return products;
	}

	public void setProducts(Set<SalesProduct> products) {
		this.products = products;
	}

	public Set<SalesUser> getUsers() {
		return users;
	}

	public void setUsers(Set<SalesUser> users) {
		this.users = users;
	}
