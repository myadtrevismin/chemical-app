...
import com.org.company.QCompanyBranch;
...
QuerydslPredicateExecutor<CompanyBranch>, QuerydslBinderCustomizer<QCompanyBranch>{
	@Override
	default void customize(QuerydslBindings bindings, QCompanyBranch obj) {
