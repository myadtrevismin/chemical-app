...
public interface FollowupRepo extends JpaRepository<Followup, Long>, QuerydslPredicateExecutor<Followup>,
		QuerydslBinderCustomizer<QFollowup> {
	@Override
	default void customize(QuerydslBindings bindings, QFollowup obj) {
		...
		bindings.bind(obj.contact).first((StringPath path, String value) -> {
