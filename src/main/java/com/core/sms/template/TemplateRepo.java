...
public interface TemplateRepo extends JpaRepository<Template, Long>, QuerydslPredicateExecutor<Template>,
		QuerydslBinderCustomizer<QTemplate> {

	@Override
	default void customize(QuerydslBindings bindings, QTemplate user) {
